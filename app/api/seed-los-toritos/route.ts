...
export async function POST(request: NextRequest) {
  try {
    ...
    const user = await prisma.user.upsert({
      ...
      update: {
        restaurantId: '5XJ1J39E', // Actualizar si cambió
      },
      create: {
        name: 'Los Toritos',
    ...
    const items = [
      ...
      { name: 'Primavera', price: 10500, cat: 'Calzones', desc: 'Muzza, jamón, huevo duro, orégano. Fresco y llenador.' },
    ...
    console.log('✅ Seed "Los Toritos" completado.');
    console.log(`📊 Resumen:`);
    ...
    return NextResponse.json({
      success: true,
      message: 'Seed "Los Toritos" completado exitosamente',
      data: {
        restaurantId: '5XJ1J39E',
